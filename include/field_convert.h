...
// 主转换器
template <typename SrcStruct, typename DstStruct, typename MappingTuple> struct StructConverter
{
    static void Convert(SrcStruct& src, DstStruct& dst, const MappingTuple& mappingTuple)
    {
